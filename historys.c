...
/**
 * get_history_files - getting file history
...
/**
 * write_historys - creating a file
 * @info: param structure
 *
...
/**
 * read_historys - readimg file  history
...
/**
 * build_history_lists - adding entry
...
/**
 * renumber_historys - renumbering lists
 * @info: Structure with the args
 *
 * Return: historycount
 */
