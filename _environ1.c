...
/**
 * _mysetenvs - channging evirnment
 * @info: Structure with the arg
 *  Return: 0 success.
 */
int _mysetenvs(info_t *info)
{
	if (info->argc != 3)
	{
...
/**
 * _myunsetenvs - Removing  env variables
 * @info: Structure with the  args
 * Return: 0 success
 */
int _myunsetenvs(info_t *info)
{
	int a;
