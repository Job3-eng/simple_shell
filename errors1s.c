...
/**
 * _erratoii - converting string to integers
 * @s: string being converted.
 * Return: 0 for no strings -1 if error
 */
int _erratoii(char *s)
{
	int a = 0;
...
/**
 * print_errors - printing message for error
 * @info: parameter
...
/**
 * remove_commentss - replacing 1st instances
 * @buf: string address.
 *
 * Return: 0 for success
 */
void remove_commentss(char *buf)
{
	int a;
